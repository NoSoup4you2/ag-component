...
import { ServerDropdownOption } from 'src/app/models/server-dropdown';
import { CustomDropdownService } from '../drop-down/drop-down.service';
  ...
  providers: [
    {
      ...
      useExisting: forwardRef(() => DropDownSample4Component),
      multi: true,
    },
    {
